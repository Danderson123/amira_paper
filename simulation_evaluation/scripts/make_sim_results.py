...
def plot_gene_positions(ax, genes_dict, positions_dict, gene_colors, scenario, global_max_pos):
    ...
    custom_y_labels = {
        ...
        4: ["chromosome"],
        5: ["chromosome"],
        6: ["plasmid", "chromosome"],
        7: ["plasmid", "chromosome", "chromosome"]
    }
...
def plot_combined(genes_data, amira_recall_data, flye_recall_data, output_file):
    ...
    grid = gridspec.GridSpec(6, 2, hspace=0.1, wspace=0.2, width_ratios=[1, 1])
    global_max_end = 0
    for s in genes_data:
...
scenario_mapping = {0: 0, 1 : 1, 2 : 2, 4 : 3, 6 : 4, 3 : 5, 5 : 6}
modified_data_list = {}
...
positions_dicts = []
amr_alleles = set()
scenario_mapping = {"test_0": "test_0",
    "test_1" : "test_1",
    "test_2" : "test_2",
    "test_3" : "test_5",
    "test_5" : "test_6",
